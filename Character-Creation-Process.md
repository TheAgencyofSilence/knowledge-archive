...
ㅤㅤ•  **Классический:** Рекомендуемо. Броски совершаются постепенно и поочередно с выбором сфер Столицы. 

ㅤㅤ•  **Воплощение концепта:** Мастер помогает создать желаемый концепт персонажа, подбирая нужное количество (из пяти доступных) Вех в соответствии с идеей игрока. 
...
(При этом нам все еще следует оставаться в рамках нашего игрового сеттинга, конечно)
...
Дайте игроку выбрать Сферу, бросить или выбрать Веху, указать примерный возраст. Согласуйте нарратив с игроком. (Пожалуйста, помните, что мы отталкиваемся именно от желания игрока, от его предложенного концепта!)
  ...
  •  Если выпал блок **Выбора** (5.Х) и если у вас есть Мастер Поддержки, объясните ситуацию игроку и временно отключите его звук, чтобы обсудить возможные варианты с сомастером. Стремитесь к тому, чтобы варианты выбора были равнозначными и не склоняли игрока к очевидному решению. 
...
Выбор должен быть интересным, без явного черно-белого разделения - оба варианта должны иметь как преимущества, так и недостатки. Если вы уверены в своей интерпретации понятий Света и Тьмы, подумайте, мог ли персонаж получить их, или его выбор будет обычным, будничным. Если сомастера нет, создайте выбор для игрока самостоятельно.
  ...
  •  Если выпал **Специальный навык**, необходимо проработать его логику и историю. Если это касается Воли, нужно уделить внимание Спектру воли. (Что такое спектр Воли можно узнать здесь (ссылка). Напоминаем, что новички в сеттинге, создавая своего первого персонажа, <u>не могут</u> выбирать опцию "специальный навык". 

  •  Если выпало **Безумие**, объясните игроку суть императивных установок, и вместе продумайте нарратив, чтобы и игрок понимал, как с этим работать, и мастерам было легче включить это в игру.  Помните, что Императивная установка должна быть: 
...
ㅤㅤㅤ⸎   Хорошая установка должна иметь не очень широкую, но и не слишком узкую область применения. 
                    
ㅤㅤㅤ⸎   Должна <u>усложнять</u> жизнь и создавать интересные ситуации на партиях.
...
ㅤㅤㅤ⸎   После того, как вы согласовали с игроком императивную установку, запишите это в чарник. [Рекомендуется заполнять Мастеру Поддержки]
  ...
  •  Если выпал **Талант**: Создание таланта - сложная механика, поэтому новоприбывшим игрокам стоит осваивать её позже, когда они лучше поймут систему и увидят, как таланты применяются в игре. 
  ...
  •  Если выпало **Преследование**, объясните игроку суть его работы и оговорите с ним на какую сферу будет наложен штраф к связям, отметьте это в соответствующей сфере.
