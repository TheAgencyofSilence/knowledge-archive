...
[Главная](index.md) → Основы игровой системы

---

# Основы игровой системы

В этом разделе собраны правила, которые лежат в основе игровой механики «Внутренних Теней». Они помогут вам разобраться в том, как устроена система, как взаимодействуют её основные элементы и какие возможности она предоставляет вашему персонажу.
