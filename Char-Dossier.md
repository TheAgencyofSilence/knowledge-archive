...
<table class="simple-table image-text-table">
    ...
    <tr>
        <td class="text-cell">
            Совет 1: делайте это по такому принципу - сначала пишите цифру модификатора, а потом символ - плюс или минус. Если сначала запишите + или -, тогда ячейка начнет считывать это как формулу, что вам не нужно. Пример правильного написания: [2+]
        </td>
...
Предел Здоровья вашего персонажа автоматически расширяется, когда вы заполняете физические навыки вашего персонажа - в блоках Стойкости и Проворства. Предел Рассудка автоматически расширяется, когда вы заполняете ментальные навыки вашего персонажа - в блоках Разума и Эго.
...
**Ошибки:** Если персонаж совершает серьёзный проступок, наносящий существенный вред Агентству, один из координаторов «Тишины» может вынести ему выговор и зафиксировать Ошибку - если, конечно, Агентство узнает о произошедшем. Если такое произошло - заполните один из пунктов "Ошибок"
...
**Дополнительные состояния:** В чарлисте также предусмотрены три незаполненных пула для состояний.
...
<table class="simple-table image-text-table">
    ...
    <tr>
        <td class="image-cell">
            <img src="assets/images/talantperzintacia2.png"
                 alt="talantperzintacia2"
                 class="image-text-picture">
        </td>

        <td class="image-cell">
            <img src="assets/images/talantperzintacia1.png"
                 alt="talantperzintacia1"
                 class="image-text-picture">
        </td>
    </tr>
...
<table class="simple-table image-text-table">
    ...
    <tr>
        <td class="text-cell">
            Ниже расположен блок Знаний и Связей.<br><br>Каждый раз, когда Мастер или таблица Карьеры сообщает вам о получении Знания или Связи, отметьте соответствующий показатель в этом блоке.<br><br>Помните, что для Знаний и Связей действует правило возрастающей стоимости развития: чем выше уже имеющийся показатель, тем сложнее его увеличивать дальше.<br><br>Значения выше 6 доступны только в рамках цепочек игр и не могут быть получены в ваншотах.
        </td>

        <td class="image-cell">
            <img src="assets/images/Znaniaisvyazi.png"
                 alt="Znaniaisvyazi"
                 class="image-text-picture">
        </td>
    </tr>
    ...
    <tr>
        <td class="text-cell">
             <strong>Преследование</strong><br><br>Под каждой Сферой также находится показатель Преследования.<br><br>Напомним, что Преследование работает как анти-Связи. Каждый пункт Преследования ухудшает броски Связей в соответствующей Сфере на 1.<br><br>Таким образом, чем выше Преследование в определённой Сфере, тем сложнее персонажу пользоваться своими Связями в ней.
        </td>

        <td class="image-cell">
            <img src="assets/images/presledovanie.png"
                 alt="presledovanie"
                 class="image-text-picture">
        </td>
    </tr>
...
<table class="simple-table image-text-table">
    ...
    <tr>
        <td class="text-cell">
            Ниже находится большой блок, предназначенный для Препаратов.<br><br>Этот блок дополняет Инвентарь, позволяя держать важную информацию об активных эффектах и свойствах препаратов непосредственно перед глазами и не искать её среди множества предметов.<br><br>Вы можете самостоятельно настраивать расположенные здесь ячейки и использовать их для хранения информации о препаратах, которыми ваш персонаж пользуется чаще всего.<br><br>Если уровень Интоксикации персонажа превышает допустимый предел, соответствующие последствия от препаратов автоматически подсвечиваются.
        </td>

        <td class="image-cell">
            <img src="assets/images/preporat.png"
                 alt="preporat"
                 class="image-text-picture">
        </td>
    </tr>
...
В правой нижней части страницы находится большой блок «Заметки».
