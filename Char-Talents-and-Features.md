...
Другим источником может быть, например, «Предыстория», если Талант был получен ещё во время создания персонажа. Третим источником может быть "Предмет", если в ваш предмет встроена особая механика. Последним источником может быть "Крафт", если вы создали "Талант-технику".
