...
<table class="simple-table image-text-table">
    ...
    <tr>
        <td class="image-cell">
            <img src="assets/images/Fioletovaya.jpg"
                 alt="Fioletovaya"
                 class="image-text-picture">
        </td>

        <td class="text-cell">
            Мы сошлись на том, что максимальным значением навыка, который человек может достичь человек в Столице – это <strong>10</strong>. Шесть пунктов навыка – это серьезнейший профессионал, мастер своего дела,  но еще четыре пункта - это уникальные персононы, которые выходит за всякую грань человеческого развития.<br><br>Напомним, что персонажи агенства могут достигнуть максимум 6 пунктов в определенном навыке.
        </td>
    </tr>
