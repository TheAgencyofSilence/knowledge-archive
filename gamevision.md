...
<table class="simple-table image-text-table">
    ...
    <tr>
        ...
        <td class="text-cell">
            Мы считаем, что у Красного примерно  <strong>10 пунктов</strong> в навыке планирования.<br><br>Это запредельно высокий показатель навыка, которым обладают лишь единицы во всей многомиллионной Столицы..<br><br> Напомним, что персонажи агенства могут достигнуть максимум 6 пунктов определнного навыка.
        </td>
    </tr>
