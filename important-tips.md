...
<div class="note note-yellow">
  <p>Текст в такой форме содержит правила и руководства, которые являются экспериментальными. Для проведения игр вам не обязательно проводить ознакомление с данными блоками. Они будут вам полезны, если:
...
* Вас утомил базовый набор правил и вы хотите поэкспериментировать</p>
</div>
