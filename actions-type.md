...
<table class="simple-table image-text-table">
    ...
    <tr>
        ...
        <td class="text-cell">
         <p><strong>Азарт</strong> - это временный ресурс, который персонаж получает за успехи, превзошедший необходимые условия задачи, и может использовать для усиления последующих действий. Подробнее об Азарте вы сможете узнать в <a href="https://theagencyofsilence.github.io/knowledge-archive/life-stats-and-how-to-play.html">соответствующей главе</a>.</p>
        </td>
    </tr>
