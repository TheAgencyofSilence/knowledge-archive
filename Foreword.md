...
<table class="simple-table image-text-table">
    ...
    <tr>
        ...
        <td class="text-cell">
         <p><strong>Здоровье</strong> определяет его живучесть и способность переносить различные повреждения: от ранений, нанесённых огнестрельным и холодным оружием, до воздействия отравляющих веществ, прямого огня, холода и некоторых болезней.</p>
        </td>
    </tr>
    ...
    <tr>
        <td class="image-cell">
            <img src="assets/images/ras1.png"
                 alt="ras1"
                 class="image-text-picture">
        </td>

        <td class="text-cell">
         <p><strong>Рассудок</strong> отражает ментальную стойкость персонажа, его собранность и способность заниматься интеллектуальной деятельностью.</p>
        </td>
    </tr>
...
<table class="simple-table image-text-table">
    ...
    <tr>
        ...
        <td class="text-cell">
         <p>При создании персонажа вы распределили <strong>навыки</strong> между четырьмя блоками: Стойкость, Проворство, Разум и Эго.<br><br>Это распределение не является окончательным: в течение первых нескольких игр вы можете свободно перераспределять свои навыки. По мере накопления опыта персонаж будет развиваться, а общее количество освоенных навыков - постепенно увеличиваться.</p>
        </td>
    </tr>
...
<table class="simple-table image-text-table">
    ...
    <tr>
        <td class="image-cell">
            <img src="assets/images/stress1.png"
                 alt="stress1"
                 class="image-text-picture">
        </td>

        <td class="text-cell">
         <p><strong>Стресс</strong> - это ресурс, связанный с ментальной деятельностью. Пункты Стресса выступают своего рода ментальным инструментом, которым персонаж распоряжается в ходе игры.</p>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="text-cell">
         <p><strong>План:</strong> Если при создании персонажа вы вложили пункты опыта в навык «План», обратите внимание, что вам также доступна возможность получать и реализовывать пункты Плана.</p>
        </td>
    </tr>
    <!-- Строка 1 -->
    <tr>
        ...
        <td class="text-cell">
         <p><strong>Проворство</strong>: В блоке Состояний вы также найдёте кубы Проворства, которые используются в бою и погонях. Количество кубов проворства зависит от того, какой показатель вашего блока навыков "Проворство"</p>
        </td>
    </tr>
...
<table class="simple-table image-text-table">
    ...
    <tr>
        ...
        <td class="text-cell">
         <p>Обратите внимание, что в вашем Листе персонажа также заполнены Знания и Связи в тех Сферах, с которыми вы взаимодействовали при создании предыстории.<br><br><strong>Знания</strong> отражают ваше понимание того, как устроена и работает соответствующая Сфера. <br><br><strong>Связи</strong> представляют собой полезные знакомства, которые могут помочь персонажу в будущем.</p>
        </td>
    </tr>
