...
[Главная](index.md) → [Домашние правила](Homerules.md) → Лист Персонажа(Character-Sheet.md) → Вкладка «Предыстория» 
...
<table class="simple-table">
  ...
  <tr>
    <th class="center">Заполнение Карточки Персонажа не является обязательным</th>
  </tr>

</table>

Ниже Вех находится Карточка Персонажа. Это дополнительный инструмент для тех, кто хочет глубже проработать своего персонажа, лучше погрузиться в его образ или подробнее познакомить с ним Мастеров и других игроков.
...
<div class="note note-gray">
  ...
  <p><strong>Наследие отца:</strong> Мой отец был важным человеком в структуре Академий, и все ожидают от меня того же. Куда бы я ни пошёл - я всё больше чувствую его. Может, меня на самом деле и вовсе нет?</p>
</div>
...
Карточка Персонажа (Темы, Заметки,  Детальное описание Вех и т.д) являются дополнительными инструментами и заполняются **по желанию игрока**.
